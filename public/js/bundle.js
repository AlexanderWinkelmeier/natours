...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWxleGFuZGVyd2kiLCJhIjoiY2tqY2liZ2phN3ljMDJycWo4dWZ4bDhzZSJ9.31ZWT7qz0D8L55aHVKm6LQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/alexanderwi/ckjcjzgj47v6z19p50h3d52pr',
    scrollZoom: false //   center: [-118.113491, 34.111745], // longitude, latitude, Los-Angeles
    //   zoom: 10,
    //   interactive: false
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            // location.reload führt zum Neuladen der Seite: true erzwingt das Neulanden vom Server, ansonsten wird die Seite aus dem Zwischenspeicher des Browsers (Cache) neu geladen
            // da nach dem Neuladen der Cookie nicht mehr gültig ist, wird der User ausgeloggt
...
var stripe = Stripe('pk_test_51HeEC1EQqHHM760j9wwZZqu5CQ1WiJoa749s7NzKdZn80agR9Wy02fKmPWQYfQClru4EKRT7Sm6Lg6T5Ka4MkogF00yVFMYTyV'); // tourId kommt von tour.pug (siehe dort ganz unten beim letzten Button)
...
var userDataForm = document.querySelector('.form-user-data'); // in account.pug

var userPasswordForm = document.querySelector('.form-user-password'); // in account.pug

var bookBtn = document.getElementById('book-tour'); // in tour.pug
// DELEGATION
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  ...
  console.log(form);
  (0, _updateSettings.updateSettings)(form, 'data'); // siehe updateSettings.js
});
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault(); // Der Submit-Button 'Save Password' wird zu 'Updating...' solange das Passwort noch nicht gespeichert ist
          ...
          case 7:
            ...
            document.querySelector('.btn--save-password').textContent = 'Save password'; // Die Felder leeren
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            tourId = e.target.dataset.tourId; // vgl. tour.pug ganz unten: e.target ist der geklickte Button

            (0, _stripe.bookTour)(tourId); // Aufruf der Funktion in stripe.js mit der abgegriffenen tourId aus tour.pug
